...
2. __Draw graph__  
   __Drawing;__ a graph can be drawn on the newly created canvas tag freehand or with script (see [__"Example with the standard normal distribution"__](https://github.com/YujiSODE/draw2Sample/blob/master/README.md#example-with-the-standard-normal-distribution)).  
